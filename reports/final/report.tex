...
\subfigure[Fooditems]
{
\includegraphics[width=0.45\linewidth]{fooditems}
}
\subfigure[Foodtastes]
{
\includegraphics[width=0.45\linewidth]{foodtastes}
}
\end{figure}
...
\subfigure[Meals]
{
\includegraphics[width=0.45\linewidth]{meals}
}
\subfigure[Service]
{
\includegraphics[width=0.45\linewidth]{service}
}
\end{figure}
